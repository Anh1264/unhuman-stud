    ...
    >
      ...
      >
        ...
        <Link
          ...
          className="hidden rounded-full border border-line-2 px-4 py-2 text-[12px] font-semibold uppercase tracking-[0.1em] transition-colors hover:border-ember hover:text-ember md:inline-block"
        >
          Contact
        </Link>
